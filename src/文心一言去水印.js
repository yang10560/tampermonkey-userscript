...
(function () {
    ...
    const hideWater = function () {
        ...
        if (location.href.indexOf("tongyi") > -1){
        ...
        if (divMask) {
            ...
            if (location.href.indexOf("tiangong") > -1) hideMask.innerHTML = `div[style*='pointer-events'] {height:0 !important;width:0 !important;transform: rotate(90deg);}`
            if (location.href.indexOf("tongyi") > -1) hideMask.innerHTML = `.digit_watermark,div[style^="pointer-events"] {height:0 !important;width:0 !important;transform: rotate(90deg);}`
